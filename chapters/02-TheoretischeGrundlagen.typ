...
Vergleichbare Entwicklungen lassen sich auch bei anderen Low-Code-Systemen beobachten: QUELLE beschreiben den Einsatz von GenAI in Low-Code/No-Code-Umgebungen allgemein, während QUELLE am Beispiel von Oracle APEX untersuchen, wie LLM-Unterstützung die Entwicklung in einer strukturell mit ServiceNow vergleichbaren Plattform beeinflusst. Diese Befunde verdeutlichen, dass die Verbindung von generativer KI und Low-Code-Entwicklung kein rein akademisches, sondern ein hochaktuelles praktisches Phänomen darstellt – und begründen damit den in dieser Arbeit gewählten Fokus auf ServiceNow als konkretes Untersuchungsfeld.

Im hier untersuchten Experiment kommt dabei mit Microsoft 365 Copilot Chat ein chatbasiertes Assistenzsystem zum Einsatz, das sich von der unmittelbar in den Editor integrierten Code-Vervollständigung klassischer Werkzeuge wie GitHub Copilot unterscheidet: Anstelle inline vorgeschlagener Codefragmente liefert es vollständige Lösungsvorschläge auf Basis dialogisch formulierter Anfragen.QUELLE Diese Unterscheidung ist für die vorliegende Arbeit insofern relevant, als sie die Interaktionsform mit der GenAI im Rahmen des Experiments unmittelbar bestimmt.
